...
=======
    ...
    showImageCommon,
    translationData,
>>>>>>> 9389ed7db1ed18ad1abb7f67a5aefd5face8fe4e
} from "../../utils/helper";
...
<<<<<<< HEAD
  ...
  return (
    <div>
      <div className="pkg-common-title mt-60">
        <h4>{title}</h4>
      </div>
      <div
        style={{
                        ...
                        <div className="deals-info">
                          <ul>
                            <li className="d-flex align-items-center">
                              ...
                              <div>
                                {it.properties.soSaoTrungBinh} (
                                {it.properties.luotXem} {translate("view")}){" "}
                              </div>
                            </li>
                            <li>
                              <span>
                          ...
                          >
                            {translationData(
                              it.properties.tenDiaDiem,
                              it.properties.tenDiaDiemUS
                            )}{" "}
                          </a>
                          <p className="text-truncate-address-destination">
                            <i className="flaticon-map"></i>
                            {translationData(
                              it.properties.diaChi,
                              it.properties.diaChiUS
                            )}{" "}
                          </p>
                        </div>
                      </div>
...
>>>>>>> 78fb19d9696ba82834f1cb705420dc09b99bc1e5
