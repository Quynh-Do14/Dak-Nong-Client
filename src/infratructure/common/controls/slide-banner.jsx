                            ...
                            <div className="col-lg-6">
                                <div className="banner-right-content">
                                    <div className="banner-right-image">
                                        <img src={slide} alt="banner-two-image" />
                                    </div>
                                    ...
                                    <div className="banner-vedio">
                                        <div className="banner-vedio-image">
                                            ...
                                            <div className="missiom-video-btn">
                                                <a href='https://www.youtube.com/watch?v=IFQWmS5Cl2w' target="_blank" className="hv-popup-link"><i className="fas fa-play"></i></a>
                                            </div>
                                        </div>
                                    ...
                                    <div className="banner-track">
                                        <div className="banner-track-image">
                                            <img src="assets/images/shape/banner-car.png" alt="img" />
