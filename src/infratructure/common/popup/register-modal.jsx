...
const RegisterPopup = (props) => {
  const { title, visible, onCancel, setLoading } = props;
  ...
  const onBlurPhoneNumber = (isImplicitChange = false) => {
    ...
    validateFields(
      ...
      validate,
      !phoneNumber
        ? `${translate("pleaseEnter")} ${translate("phoneNumber")}`
        : ""
    );
  };
  ...
  const onBlurFirstName = (isImplicitChange = false) => {
    ...
    validateFields(
      ...
      setValidate,
      validate,
      !firstName ? `${translate("pleaseEnter")} ${translate("firstName")}` : ""
    );
  };
  ...
  const onBlurLastName = (isImplicitChange = false) => {
    ...
    validateFields(
      ...
      setValidate,
      validate,
      !lastName ? `${translate("pleaseEnter")} ${translate("lastName")}` : ""
    );
  };
  ...
  const onBlurAddress = (isImplicitChange = false) => {
    ...
    validateFields(
      ...
      setValidate,
      validate,
      !address ? `${translate("pleaseEnter")} ${translate("address")}` : ""
    );
  };
    ...
    >
          ...
          <div className="d-flex flex-column text-center">
            <form>
              ...
              <div className="form-input mb-3">
                ...
                />
                <MessageError
                  isError={validate.firstName?.isError || false}
              ...
              <div className="form-input mb-3">
                ...
                />
                <MessageError
                  isError={validate.lastName?.isError || false}
              ...
              <div className="form-input mb-3">
                <input
                  ...
                  onBlur={() => onBlurPhoneNumber(false)}
                  type="text"
                  className="form-control"
                  id="phoneNumber1"
                ...
                />
                <MessageError
                  isError={validate.phoneNumber?.isError || false}
              ...
              <div className="form-input mb-3">
                ...
                />
                <MessageError
                  isError={validate.address?.isError || false}
      ...
      <div className="modal-footer d-flex justify-content-center">
        <div className="signup-section">
          ...
          <a onClick={onCancel} className="text-info">
            {" "}
            {`${translate("signIn")}`}
          </a>
          .
